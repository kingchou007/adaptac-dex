...
from adaptac.model.diffusion_modules.module_attr_mixin import ModuleAttrMixin
...
class LowdimMaskGenerator(ModuleAttrMixin):
    ...
    def forward(self, shape, seed=None):
        ...
        ), f"Expected D=action_dim+obs_dim={self.action_dim}+{self.obs_dim}={self.action_dim+self.obs_dim}, got D={D}"
