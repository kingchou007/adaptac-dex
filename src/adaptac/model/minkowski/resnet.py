...
from adaptac.model.minkowski.common import (
    ConvType,
    NormType,
    get_norm,
    conv,
...
from adaptac.model.minkowski.resnet_block import BasicBlock, Bottleneck
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.network_initialization(
            in_channels, out_channels, conv1_kernel_size, dilations, bn_momentum, D
        )
        self.weight_initialization()

    def network_initialization(
        self, in_channels, out_channels, conv1_kernel_size, dilations, bn_momentum, D
    ):
